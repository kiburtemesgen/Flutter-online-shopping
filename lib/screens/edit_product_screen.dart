...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void _saveForm() {
    ...
    if (_editedProduct.id != null) {
      ...
      Provider.of<Products>(context, listen: false)
          .addFsProducts(_editedProduct);
      print(_editedProduct.quantity);
                    ...
                    TextFormField(
                      ...
                      onSaved: (value) {
                        _editedProduct = Product(
                            ...
                            isFeatured: _editedProduct.isFeatured,
                            productCategoryName:
                                _editedProduct.productCategoryName,
                          ...
                          child: TextFormField(
                            ...
                            onSaved: (value) {
                              _editedProduct = Product(
                                  ...
                                  id: _editedProduct.id,
                                  isFeatured: _editedProduct.isFeatured,
                                  productCategoryName: _editedProduct.productCategoryName,
                                  brand: _editedProduct.brand,
                                  quantity: _editedProduct.quantity);
                            },
                          ),
